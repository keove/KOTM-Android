...
import com.keove.mylibrary.KOTM;
import com.keove.mylibrary.KOTMTag;
...
public class MainActivity extends AppCompatActivity {
    ...
    @KOTMTag("test_prj_tv") AppCompatTextView textView;

    @KOTMTag("test_prj_et") AppCompatEditText editText;

    @KOTMTag("test_prj_btn") AppCompatButton button;

    AppCompatTextView tv2, tv3;

    @KOTMTag("test_prj_string") String text = null;

    @KOTMTag("test_prj_array") ArrayList<String> texts = null;
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        KOTM.setLanguage(this, "TR");
        KOTM.setTranslationMap(this, json);
        KOTM.translate(this, this);
